# -*- coding: utf-8 -*-
"""
Created on Wed Jul 08 23:11:18 2015
...
K=4 #four clusters
num_deals = len(offer_sheet_data) #assume listed offers are distinct 33
...
customer_names.sort()
num_customers = len(customer_names)#unique cutomers
