...
/*
 * In this class I calculated the query time for 2000 random queries 
 * 
 */

public class DBRandomQuery {
...
public static void main(String[] args) {
   ...
   try{
      ...
      /*
       *  In this loop we execute a query for 2000 times 
       */
    ...
    {  	
	   ...
	   //Random Query 	
        stmt.executeQuery("SELECT latitude,longitude,mag FROM all_month where nst="+randomNum+";");
      ...
      System.out.println("Time taken to execute 2000 random queries "+s.getTotalTimeSeconds()+" secs");
